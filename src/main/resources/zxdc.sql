...
CREATE TABLE `t_order` (
  ...
  `toalprice` double default NULL,
  `project` bigint(20) default NULL,
  `user` bigint(20) default NULL,
  PRIMARY KEY  (`id`),
  KEY `FK_pd8nd1mb39msifrjxxubrkoia` (`project`),
  KEY `FK_1isv5n8ndeuw5y3mwianl1j94` (`user`),
  CONSTRAINT `FK_1isv5n8ndeuw5y3mwianl1j94` FOREIGN KEY (`user`) REFERENCES `t_user` (`id`),
  CONSTRAINT `FK_pd8nd1mb39msifrjxxubrkoia` FOREIGN KEY (`project`) REFERENCES `t_project` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_project` (
  ...
  PRIMARY KEY  (`id`),
  KEY `FK_l7h2e0tyeyt7kyp357g78586s` (`category`),
  CONSTRAINT `FK_l7h2e0tyeyt7kyp357g78586s` FOREIGN KEY (`category`) REFERENCES `t_category` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_survey_question` (
  ...
  UNIQUE KEY `UK_1snpofbu6f82icxu75h8t1wnd` (`q_id`),
...
INSERT INTO `t_survey_question` VALUES ('4', '3');
