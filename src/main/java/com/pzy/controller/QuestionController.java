...
public class QuestionController {
	...
	public Map<String, Object> list(
		...
		Page<Question> questions = questionService.findAll(pageNumber, pageSize, name);
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("aaData", questions.getContent());
		map.put("iTotalRecords", questions.getTotalElements());
		map.put("iTotalDisplayRecords", questions.getTotalElements());
		map.put("sEcho", sEcho);
		return map;
	}
